...
('Rocket.Chat', 'Colaboración', 'Plataforma de mensajería y colaboración en equipo open source con soporte para integración de bots, APIs y canales seguros.', '{"Comunicación interna","Integración con herramientas empresariales","Mensajería en tiempo real"}', 'Comunicación en equipo'),

('Snipe-IT', 'IT Asset Management (ITAM)', 'Plataforma para gestionar inventarios de hardware y software, seguimiento de licencias y control de activos en empresas.', '{"Inventario de hardware y software","Gestión de licencias","Control de activos TI"}', 'Gestión de activos TI'),
...
('DSS01-P05-A04', 'DSS01-P05', 'Confirme que el cableado externo al sitio de TI esté ubicado bajo tierra o cuente con protección alternativa adecuada. Asegúrese de que el cableado dentro del sitio de TI esté dentro de conductos seguros y que el acceso a los gabinetes de cableado esté restringido al personal autorizado. Proteja adecuadamente el cableado contra daños causados por fuego, humo, agua, interceptación e interferencias.', 2, 'Eramba', 'Puedes establecer políticas y controles de protección física.', 'La herramienta solo facilita la documentación, debido a la propiedad fisica de la actividad', '-'),
...
('DSS05-P04-A07', 'DSS05-P04', 'Mantener un registro de auditoría del acceso a la información en función de su sensibilidad y los requisitos reglamentarios.', 4, 'Zabbix', 'Registra eventos y accesos configurables, alineado a parámetros de seguridad.', 'Requiere configuración de triggers y plantillas.', 'Syslog / SIEM'),
...
('DSS05-P05-A03', 'DSS05-P05', 'Exigir que los visitantes estén escoltados en todo momento mientras se encuentren en el lugar.', 2, 'GLPI', 'Asignación de acompañantes mediante tareas o responsables.', 'Se puede configurar como política interna de atención.', 'Formcreator'),
...
('DSS05-P06-A01', 'DSS05-P06', 'Establecer procedimientos para regular la recepción, el uso, la eliminación y la disposición de documentos confidenciales y dispositivos de salida dentro y fuera de la empresa.', 2, 'GLPI', 'Documenta procedimientos y el ciclo de vida de activos.', 'Usa plugins para trazabilidad.', 'Formcreator / DataInjection'),
...
('DSS05-P06-A05', 'DSS05-P06', 'Establecer medidas de seguridad físicas adecuadas para los documentos sensibles.', 3, 'Eramba', 'Gestión documental de controles físicos de seguridad.', 'No ejecuta controles, los documenta.', 'Herramientas de cumplimiento externo'),
...
('DSS05-P07-A05', 'DSS05-P07', 'Registrar eventos relacionados con la seguridad y conservar los registros durante el período apropiado.', 3, 'Snort', 'IDS que registra y almacena tráfico y eventos de seguridad.', 'Puede integrarse con sistemas de alerta y SIEM.', 'Zabbix / syslog / GLPI'),
...
('DSS06-P04-A05', 'DSS06-P04', 'Informar oportunamente los errores relevantes del proceso de información empresarial para realizar un análisis de causa raíz y tendencias.', 4, 'Zabbix', 'Permite registrar eventos, crear alertas y generar reportes para análisis de tendencias de errores.', 'Ideal para eventos de infraestructura o sistemas críticos.', 'Integración con Grafana para visualización avanzada'),

('DSS06-P05-A01', 'DSS06-P05', 'Capturar la información de la fuente, la evidencia de apoyo y el registro de las transacciones.', 2, 'Zabbix', 'Zabbix permite recopilar registros detallados de eventos, monitorear la infraestructura, y almacenar métricas y alertas que pueden actuar como evidencia de soporte.', 'Puede extenderse con scripts personalizados para capturar registros más específicos.', 'Integración con syslog y bases de datos externas'),
...
('BAI01-P07-A03', 'BAI01-P07', 'Definir cualquier requisito para la validación y verificación independiente de la calidad de los entregables del plan.', 4, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('BAI02-P01-A02', 'BAI02-P01', 'Expresar los requisitos del negocio en términos de cómo debe abordarse la brecha entre las capacidades comerciales actuales y deseadas y cómo el usuario (empleado, cliente, etc.) interactuará con la solución y la utilizará.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('BAI02-P01-A09', 'BAI02-P01', 'Validar todos los requisitos mediante enfoques como la revisión por pares, la validación de modelos o la creación de prototipos operativos.', 3, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('BAI03-P01-A02', 'BAI03-P01', 'Involucrar a diseñadores de experiencia de usuario y especialistas en TI debidamente calificados y con experiencia en el proceso de diseño para asegurarse de que el diseño proporcione una solución que utilice de manera óptima las capacidades de I&T propuestas para mejorar el proceso comercial.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('BAI05-P03-A01', 'BAI05-P03', 'Desarrollar un plan de comunicación de la visión para abordar los grupos de audiencia principales, sus perfiles de comportamiento y requisitos de información, canales de comunicación y principios.', 3, 'Rocket.Chat', 'Permite crear canales temáticos, comunicaciones repetitivas y verificación de lectura', 'Se adapta a comunicación estratégica y masiva interna', '-'),
...
('BAI05-P03-A03', 'BAI05-P03', 'Reforzar la comunicación a través de múltiples foros y repetición.', 3, 'GLPI', 'GLPI gestiona mejoras rápidas (proyectos), Rocket.Chat comunica y refuerza', 'Se logra una combinación efectiva de acción y divulgación', 'Rocket.Chat'),
...
('BAI05-P04-A06', 'BAI05-P04', 'Identificar y gestionar a los líderes que continúan resistiéndose al cambio necesario.', 3, 'OrangeHRM', 'A través de métricas de desempeño; requiere refuerzo para lo cultural', 'Puede apoyarse en observaciones informales', 'Rocket.Chat'),
...
('BAI05-P06-A02', 'BAI05-P06', 'Celebrar los éxitos e implementar programas de recompensa y reconocimiento para reforzar el cambio.', 3, 'Rocket.Chat', 'Campañas internas de reconocimiento, integración con RRHH', 'Refuerza cultura de cambio positiva', '-'),

('BAI05-P06-A03', 'BAI05-P06', 'Proporcionar conciencia continua mediante la comunicación regular del cambio y su adopción.', 3, 'Rocket.Chat', 'Canales dedicados a la transformación, newsletters, recordatorios', 'Refuerzo clave para mantener conciencia activa', '-'),
...
('BAI09-P01-A01', 'BAI09-P01', 'Identifique todos los activos propios en un registro de activos que registre su estado actual. Los activos se reportan en el balance general; se compran o crean para aumentar el valor de una empresa o para beneficiar sus operaciones (por ejemplo, hardware y software). Identifique todos los activos propios y manténgalos alineados con los procesos de gestión de cambios y gestión de la configuración, el sistema de gestión de la configuración y los registros contables.', 2, 'Snipe-IT', 'Permite registrar activos con estado actual, historial de cambios, responsable, ubicación y más', 'Soporta etiquetas QR, auditoría, categorías y relaciones', 'Puede integrarse con OpenAudIT para detección automática o con GLPI para gestión de incidencias'),

('BAI09-P01-A02', 'BAI09-P01', 'Identificar los requisitos legales, reglamentarios o contractuales que deben abordarse al gestionar el activo.', 2, 'Snipe-IT', 'Permite campos personalizados para registrar información legal y contractual relevante', 'Requiere definición de políticas organizacionales dentro de los formularios', 'Integrable con herramientas de cumplimiento como Eramba o Wazuh'),

('BAI09-P01-A03', 'BAI09-P01', 'Verificar que los activos sean aptos para el propósito (es decir, que estén en condiciones útiles).', 2, 'Snipe-IT', 'El historial y el estado de los activos permite verificar su condición y utilidad', 'Se pueden usar etiquetas y políticas para marcar activos con fallos o en revisión', 'Posible integración con Zabbix o TacticalRMM para monitoreo de salud'),

('BAI09-P01-A04', 'BAI09-P01', 'Garantizar la contabilidad de todos los activos.', 3, 'Snipe-IT', 'Ofrece exportación detallada y seguimiento financiero de activos (costo, depreciación, etc.)', 'Compatible con políticas contables si se parametriza correctamente', 'Puede integrarse con ERP como Apache OFBiz o soluciones contables externas'),

('BAI09-P01-A05', 'BAI09-P01', 'Verificar la existencia de todos los activos propios mediante la realización periódica de comprobaciones físicas y lógicas de inventario y su conciliación. Incluir el uso de herramientas de detección de software.', 4, 'Snipe-IT', 'Snipe-IT permite mantener un inventario centralizado de hardware y software, realizar auditorías de activos y llevar trazabilidad de asignaciones. Su API e integraciones permiten complementarlo con agentes de detección automática (ej. OCS Inventory), facilitando la verificación periódica y conciliación entre inventario físico y lógico.', 'Snipe-IT por sí solo no detecta software instalado en los equipos, pero su fortaleza está en el control documental, trazabilidad y auditoría de inventario. Se recomienda integrarlo con un agente de descubrimiento (OCS/FusionInventory) para cubrir la detección automática de software y cumplir plenamente la actividad.', 'API para integraciones con detectores automáticos.'),

('BAI09-P01-A06', 'BAI09-P01', 'Determine periódicamente si cada activo continúa aportando valor. De ser así, calcule la vida útil esperada para que siga aportando valor.', 4, 'Snipe-IT', 'Incluye campos de costo, fecha de adquisición y depreciación, lo cual permite cálculos de valor residual', 'Las políticas de depreciación deben ser definidas según normativa interna', 'Puede exportarse para análisis financiero externo'),

('BAI09-P02-A01', 'BAI09-P02', 'Identificar los activos que son críticos para brindar capacidad de servicio haciendo referencia a los requisitos en las definiciones de servicio, los SLA y el sistema de gestión de la configuración.', 2, 'Zabbix', 'Permite definir activos y monitorearlos según parámetros de criticidad y SLAs.', 'Se pueden etiquetar activos como críticos y agruparlos.', 'Puede integrarse con GLPI, iTop, Snipe-IT, OpenAudIT.'),
...
('APO01-P05-A07', 'APO01-P05', 'Implementar prácticas de supervisión adecuadas para garantizar el correcto ejercicio de las funciones y responsabilidades, evaluar si todo el personal cuenta con la autoridad y los recursos suficientes para desempeñarlas y, en general, evaluar su desempeño. El nivel de supervisión debe estar acorde con la sensibilidad del puesto y el alcance de las responsabilidades asignadas.', 3, 'Eramba', 'Tiene funciones de supervisión y evaluación periódica del cumplimiento.', 'Permite revisar efectividad segun los parametros definidos del rol de cada responsable.', '-'),
...
('APO01-P06-A03', 'APO01-P06', 'Definir la ubicación de la función de TI y obtener un acuerdo.', 3, 'Archi', 'Se pueden documentar decisiones de ubicación y acuerdos.', 'No ejecuta acuerdos, pero soporta su diseño y visualización.', '-'),

('APO01-P07-A01', 'APO01-P07', 'Proporcionar directrices para garantizar una clasificación adecuada y coherente de los elementos de información en toda la empresa.', 3, 'Archi', 'Permite modelar conceptos como entidades de datos, clasificaciones e información.', 'No realiza la clasificación directamente, pero sí su representación estructural.', '-'),
...
('APO01-P11-A02', 'APO01-P11', 'Identificar los procesos críticos para el negocio según los factores de rendimiento y cumplimiento, así como los riesgos asociados. Evaluar la capacidad e identificar objetivos de mejora. Analizar las deficiencias en la capacidad y el control. Identificar opciones para mejorar o rediseñar el proceso.', 4, 'Archi', 'Puede representar procesos críticos y analizar relaciones entre capacidades, riesgos y controles.', 'No permite evaluar capacidades en tiempo real.', '-'),
...
('APO01-P11-A06', 'APO01-P11', 'Retirar los componentes de gobernanza obsoletos (procesos, elementos de información, políticas, etc.).', 5, 'Archi', 'Permite visualizar qué elementos del marco ya no tienen relaciones funcionales y pueden retirarse.', 'Ideal para detección estructural de obsolescencia.', '-'),
...
('APO03-P01-A05', 'APO03-P01', 'Evaluar la preparación de la empresa para el cambio.', 2, 'Archi', 'Puede representar niveles de madurez, restricciones y readiness para transformación.', 'Apto para análisis de impacto y readiness.', '-'),

('APO03-P01-A06', 'APO03-P01', 'Defina el alcance de la arquitectura base y la arquitectura objetivo. Enumere los elementos dentro y fuera del alcance. (La arquitectura base y la arquitectura objetivo no necesitan describirse con el mismo nivel de detalle).', 2, 'Archi', 'Modela arquitectura actual y futura con vistas comparativas.', 'Permite delimitar dominio y evolución.', '-'),

('APO03-P01-A07', 'APO03-P01', 'Comprender las metas y objetivos estratégicos empresariales actuales. Trabajar dentro del proceso de planificación estratégica para garantizar que las oportunidades de arquitectura empresarial relacionadas con I&T se aprovechen en el desarrollo del plan estratégico.', 2, 'Archi', 'Vincula iniciativas de arquitectura con procesos de planificación estratégica.', 'Facilita participación en procesos de planificación.', '-'),
...
('APO04-P02-A03', 'APO04-P02', 'Comprender los parámetros de inversión empresarial en innovación y nuevas tecnologías para desarrollar estrategias adecuadas.', 3, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('APO04-P03-A02', 'APO04-P03', 'Establecer un proceso de vigilancia tecnológica y realizar investigaciones y análisis del entorno externo, incluidos sitios web, revistas y conferencias apropiados, para identificar tecnologías emergentes y su valor potencial para la empresa.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),

('APO04-P03-A03', 'APO04-P03', 'Consultar a expertos externos según sea necesario para confirmar la investigación o proporcionar información sobre tecnologías emergentes.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('APO05-P01-A02', 'APO05-P01', 'Identificar opciones para financiación adicional de inversiones habilitadas para I+T, considerando fuentes tanto internas como externas.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),

('APO05-P01-A03', 'APO05-P01', 'Determinar las implicaciones de la fuente de financiamiento en las expectativas de retorno de la inversión.', 2, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('APO05-P02-A03', 'APO05-P02', 'Evaluar el impacto de agregar programas potenciales en la cartera general de inversiones, incluidos los cambios que podrían requerirse en otros programas.', 3, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),

('APO05-P02-A04', 'APO05-P02', 'Decida qué programas candidatos deben transferirse a la cartera de inversión activa. Determine si los programas rechazados deben conservarse para su posterior consideración o recibir financiación inicial para determinar si se puede mejorar el modelo de negocio o descartarlos.', 3, 'Apache Open', 'Herramienta documental, puede servir para reportar los hallazgos', 'Debido a la caracteristica de la actividad, no existe una herramienta que pueda cumplirla, es solo una solución documental', '-'),
...
('EDM01-P01-A01', 'EDM01-P01', 'Analizar e identificar los factores ambientales internos y externos (obligaciones legales, regulatorias y contractuales) y las tendencias en el entorno empresarial que puedan influir en el diseño de la gobernanza.', 2, 'Apache Open', 'Puede documentarse en texto o tablas. Herramienta de soporte manual.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),
...
('EDM01-P01-A04', 'EDM01-P01', 'Determinar las implicaciones del entorno de control general de la empresa con respecto a I&T.', 2, 'Apache Open', 'Se pueden modelar escenarios de control mediante textos o tablas.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),

('EDM01-P01-A05', 'EDM01-P01', 'Alinear el uso y procesamiento ético de la información y su impacto en la sociedad, el medio ambiente natural y los intereses de las partes interesadas internas y externas con la dirección, las metas y los objetivos de la empresa.', 3, 'Apache Open', 'Ideal para formular políticas éticas y vincularlas a objetivos.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),

('EDM01-P01-A06', 'EDM01-P01', 'Articular principios que guiarán el diseño de la gobernanza y la toma de decisiones de I&T.', 3, 'Apache Open', 'Se pueden redactar y comunicar principios de decisión.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),

('EDM01-P01-A07', 'EDM01-P01', 'Determinar el modelo de toma de decisiones óptimo para I&T.', 3, 'Apache Open', 'Pueden establecerse estructuras jerárquicas en textos, diagramas o tablas.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),

('EDM01-P01-A08', 'EDM01-P01', 'Determinar los niveles apropiados de delegación de autoridad, incluidas las reglas de umbral, para las decisiones de I&T.', 3, 'Apache Open', 'Se puede documentar una matriz RACI o reglas de escalamiento.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),

('EDM01-P02-A01', 'EDM01-P02', 'Comunicar los principios de gobernanza de I&T y acordar con la dirección ejecutiva la forma de establecer un liderazgo informado y comprometido.', 2, 'Apache Open', 'Se pueden crear presentaciones, documentos estratégicos y comunicados.', 'Herramienta de apoyo documental, no ejecuta la acción.', '-'),
...
('EDM01-P02-A03', 'EDM01-P02', 'Establecer una junta directiva de I+T (o equivalente). Esta junta debe garantizar que la gobernanza de la información y la tecnología, como parte de la gobernanza empresarial, se aborde adecuadamente; asesorar sobre la dirección estratégica; y determinar la priorización de los programas de inversión en I+T, de acuerdo con la estrategia y las prioridades de la empresa.', 2, 'Archi', 'Puedes representar la junta como nodo organizacional.', 'Puede representar pero no gestionar la junta.', '-'),

('EDM01-P02-A04', 'EDM01-P02', 'Asignar responsabilidad, autoridad y rendición de cuentas por las decisiones de I&T de acuerdo con los principios de diseño de gobernanza acordados, los modelos de toma de decisiones y la delegación.', 3, 'Archi', 'Soporta modelado de autoridad, responsabilidad y estructuras jerárquicas.', 'Se puede modelar la asignación, no gestionarla.', '-'),
